# BYM x86 Emulator
BYM x86 emulates an x86-compatible CPU and hardware. Machine code is translated to
...
Shoot me an email to `BYM-Tech@outlook.com`. Please report bugs on GitHub.
